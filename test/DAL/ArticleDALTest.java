...
public class ArticleDALTest {
    ...
    public void testInsert() {
        ...
        Article article = new Article(10, 1, 2, "title0", "author1, author2", currentTimestamp, "/path/7.pdf", "tag", "annotation");
        ArticleDAL instance = new ArticleDAL();
        int expResult = 1;
    ...
    public void testUpdate() {
        Timestamp currentTimestamp = new Timestamp(System.currentTimeMillis());
        Article article = new Article(1, 1, 2, "title0", "author1, author2", currentTimestamp, "/path/1.pdf", "tag", "annotation");
        ArticleDAL instance = new ArticleDAL();
